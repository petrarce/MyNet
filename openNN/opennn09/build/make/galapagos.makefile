...
#                                                                                                                #
#   TIME SERIES PREDICTION M A K E F I L E                                        #
#                                                                                                                #
...
EXE_NAME = $(OBJECTS_DIR)/galapagos.exe
...
all:
	$(MAKE) -f galapagos.makefile deb

deb:
	+( make -f tinyxml.makefile)
	+( make -f opennn.makefile)
	$(MAKE) -f galapagos.makefile exe

rel:
	+(make -f opennn.makefile rel )
	+(make -f tinyxml.makefile rel)
	$(MAKE) -f galapagos.makefile exe "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
...
clean:
	...
	$(MAKE) -f galapagos.makefile clean_rel "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
